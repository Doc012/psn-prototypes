    ...
    const fetchData = async () => {
      try {
        ...
        const mockNotifications = [
          ...
          { id: 2, message: 'Attorney added a note to your case', date: '2023-05-18', read: false },
          { id: 3, message: 'Upcoming court date reminder', date: '2023-05-15', read: true },
          { id: 4, message: 'New invoice available', date: '2023-05-10', read: true },
        ];
        
        const mockDocuments = [
          { id: 1, name: 'Settlement Agreement.pdf', uploadDate: '2023-05-20', status: 'Needs Review' },
          { id: 2, name: 'Medical Records.pdf', uploadDate: '2023-05-15', status: 'Approved' },
          { id: 3, name: 'Witness Statement.docx', uploadDate: '2023-05-10', status: 'Approved' },
          { id: 4, name: 'Contract Draft.docx', uploadDate: '2023-05-05', status: 'Needs Signature' },
        ];
        
        const mockInvoices = [
          { id: 1, number: 'INV-2023-001', amount: 1250.00, dueDate: '2023-06-01', status: 'Unpaid' },
          { id: 2, number: 'INV-2023-002', amount: 750.00, dueDate: '2023-05-15', status: 'Paid' },
        ];
        ...
        <div className="py-4">
          ...
          <div className="grid grid-cols-1 gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
            <div className="bg-white overflow-hidden shadow rounded-lg">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd>
                        <div className="text-lg font-medium text-gray-900">{cases.filter(c => c.status === 'Active').length}</div>
                      </dd>
                    </dl>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <Link to="/client-portal/cases" className="font-medium text-[#800000] hover:text-[#600000]">View all</Link>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <Link to="/client-portal/calendar" className="font-medium text-[#800000] hover:text-[#600000]">View calendar</Link>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd>
                        <div className="text-lg font-medium text-gray-900">{notifications.filter(n => !n.read).length}</div>
                      </dd>
                    </dl>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <Link to="/client-portal/messages" className="font-medium text-[#800000] hover:text-[#600000]">View messages</Link>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <Link to="/client-portal/documents" className="font-medium text-[#800000] hover:text-[#600000]">View documents</Link>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white shadow rounded-lg mb-8">
                  ...
                  {cases.map((caseItem) => (
                    <tr key={caseItem.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <Link to={`/client-portal/cases/${caseItem.id}`} className="text-[#800000] hover:text-[#600000]">View</Link>
                      </td>
                    </tr>
                  ))}
                </tbody>
            ...
            <div className="bg-gray-50 px-6 py-3 border-t border-gray-200">
              <div className="text-sm">
                <Link to="/client-portal/cases" className="font-medium text-[#800000] hover:text-[#600000]">View all cases</Link>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div className="bg-white shadow rounded-lg">
              ...
              <div className="bg-gray-50 px-6 py-3 border-t border-gray-200">
                <div className="text-sm">
                  <Link to="/client-portal/notifications" className="font-medium text-[#800000] hover:text-[#600000]">View all notifications</Link>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white shadow rounded-lg mt-8">
            ...
            <div className="p-6">
              <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4">
                <Link to="/client-portal/documents/upload" className="text-center py-3 px-4 rounded-md bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
                ...
                <Link to="/client-portal/messages/new" className="text-center py-3 px-4 rounded-md bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
                ...
                <Link to="/client-portal/invoices" className="text-center py-3 px-4 rounded-md bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
                ...
                <Link to="/client-portal/support" className="text-center py-3 px-4 rounded-md bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
